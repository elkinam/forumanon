...
class backup_forum_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        if ($userinfo) {
            ...
            $subscription->set_source_table('forumanon_subscriptions', array('forum' => backup::VAR_PARENTID));

            $read->set_source_table('forumanon_read', array('forumid' => backup::VAR_PARENTID));

            $track->set_source_table('forumanon_track_prefs', array('forumid' => backup::VAR_PARENTID));

            $rating->set_source_table('rating', array('contextid'  => backup::VAR_CONTEXTID,
                                                      'component'  => 'mod_forumanon',
                                                      'ratingarea' => 'post',
        ...
        $forum->annotate_files('mod_forumanon', 'intro', null); // This file area hasn't itemid

        $post->annotate_files('mod_forumanon', 'post', 'id');
        $post->annotate_files('mod_forumanon', 'attachment', 'id');
