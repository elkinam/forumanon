...
require_once($CFG->dirroot . '/mod/forumanon/backup/moodle2/backup_forum_stepslib.php'); // Because it exists (must)
require_once($CFG->dirroot . '/mod/forumanon/backup/moodle2/backup_forum_settingslib.php'); // Because it exists (optional)
