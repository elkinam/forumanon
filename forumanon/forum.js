...
function forum_produce_subscribe_link(forumid, backtoindex, ltext, ltitle) {
    ...
    if(subs_link){
        subs_link.innerHTML = "<a title='"+ltitle+"' href='"+M.cfg.wwwroot+"/mod/forumanon/subscribe.php?id="+forumid+backtoindex+"&amp;sesskey="+M.cfg.sesskey+"'>"+ltext+"<\/a>";
    }
}
...
function forum_produce_tracking_link(forumid, ltext, ltitle) {
    ...
    var subs_link = document.getElementById(elementid);
    if(subs_link){
        subs_link.innerHTML = "<a title='"+ltitle+"' href='"+M.cfg.wwwroot+"/mod/forumanon/settracking.php?id="+forumid+"'>"+ltext+"<\/a>";
    }
}
