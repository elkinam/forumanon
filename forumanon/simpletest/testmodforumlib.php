...
/**
 * Unit tests for (some of) ../mod/forumanon/lib.php.
 *
...
class modforumlib_test extends UnitTestCase {
    public static $includecoverage = array('mod/forumanon/lib.php');
    ...
    function test_forumanon_cron() {
        // watch out: forumanon_cron() should not be called from here,
