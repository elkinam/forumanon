...
/*
    public static $includecoverage = array('lib/portfoliolib.php', 'mod/forumanon/lib.php');
    public $module_type = 'forumanon';
    ...
    public function setUp() {
        ...
        $discussions = $DB->get_records('forumanon_discussions', array('forum' => $first_module->id));
        $first_discussion = reset($discussions);

        $posts = $DB->get_records('forumanon_posts', array('discussion' => $first_discussion->id));
